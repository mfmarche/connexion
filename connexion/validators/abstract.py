...
class AbstractRequestBodyValidator:
    ...
    def _insert_body(self, receive: Receive, *, body: t.Any, scope: Scope) -> t.Tuple[Receive, Scope]:
        """
    ...
    async def wrap_receive(self, receive: Receive, *, scope: Scope) -> t.Tuple[Receive, Scope]:
        """
